...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        for observable in self._observables():
            observable.changed.connect(lambda *_: self._schedule_save())
    ...
    def _observables(self):
        return [
            ...
            self.capture_monitor, self.hotkey_start, self.hotkey_stop,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(bait_priority, list):
            bait_priority = []
    ...
    def _schedule_save(self) -> None:
        ...
        # Don't create/use a QTimer from a worker thread.
